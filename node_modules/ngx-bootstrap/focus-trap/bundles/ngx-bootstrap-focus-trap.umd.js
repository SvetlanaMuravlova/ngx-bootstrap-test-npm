(function (global, factory) {
    ...
    FocusTrapManager.ɵprov = i0.ɵɵdefineInjectable({ token: FocusTrapManager, factory: FocusTrapManager.ɵfac, providedIn: 'root' });
    (function () {
    ...
    Platform.ɵfac = function Platform_Factory(t) { return new (t || Platform)(i0.ɵɵinject(i0.PLATFORM_ID)); };
    Platform.ɵprov = i0.ɵɵdefineInjectable({ token: Platform, factory: Platform.ɵfac, providedIn: 'root' });
    (function () {
    ...
    InteractivityChecker.ɵfac = function InteractivityChecker_Factory(t) { return new (t || InteractivityChecker)(i0.ɵɵinject(Platform)); };
    InteractivityChecker.ɵprov = i0.ɵɵdefineInjectable({ token: InteractivityChecker, factory: InteractivityChecker.ɵfac, providedIn: 'root' });
    (function () {
    ...
    FocusTrapFactory.ɵfac = function FocusTrapFactory_Factory(t) { return new (t || FocusTrapFactory)(i0.ɵɵinject(InteractivityChecker), i0.ɵɵinject(i0.NgZone), i0.ɵɵinject(common.DOCUMENT)); };
    FocusTrapFactory.ɵprov = i0.ɵɵdefineInjectable({ token: FocusTrapFactory, factory: FocusTrapFactory.ɵfac, providedIn: 'root' });
    (function () {
    ...
    FocusTrapDirective.ɵfac = function FocusTrapDirective_Factory(t) { return new (t || FocusTrapDirective)(i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(FocusTrapFactory), i0.ɵɵdirectiveInject(common.DOCUMENT)); };
    FocusTrapDirective.ɵdir = i0.ɵɵdefineDirective({ type: FocusTrapDirective, selectors: [["", "focusTrap", ""]], inputs: { enabled: ["cdkTrapFocus", "enabled"], autoCapture: ["cdkTrapFocusAutoCapture", "autoCapture"] }, exportAs: ["focusTrap"], features: [i0.ɵɵNgOnChangesFeature] });
    (function () {
    ...
    FocusTrapModule.ɵinj = i0.ɵɵdefineInjector({ factory: function FocusTrapModule_Factory(t) { return new (t || FocusTrapModule)(); }, imports: [[common.CommonModule]] });
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(FocusTrapModule, { declarations: [FocusTrapDirective], imports: [common.CommonModule], exports: [FocusTrapDirective] }); })();
    (function () {
