    ...
    ***************************************************************************** */
    ...
    var TimepickerComponent = /** @class */ (function () {
        function TimepickerComponent(_config, _cd, _store, _timepickerActions) {
            ...
            this.meridianChange = new i0.EventEmitter();
            // ui variables
            this.hours = '';
            this.minutes = '';
            this.seconds = '';
            ...
            _store
                ...
                var isTimepickerInputValid = isInputValid(_this.hours, _this.minutes, _this.seconds, _this.isPM());
                var isValid = _this.config.allowEmptyTime ?
                    _this.isOneOfDatesIsEmpty() || isTimepickerInputValid
        ...
        TimepickerComponent.prototype.updateHours = function (target) {
            ...
            var isTimepickerInputValid = isHourInputValid(this.hours, this.isPM()) && this.isValidLimit();
            var isValid = this.config.allowEmptyTime ?
        ...
        TimepickerComponent.prototype.updateMinutes = function (target) {
            ...
            var isTimepickerInputValid = isMinuteInputValid(this.minutes) && this.isValidLimit();
            var isValid = this.config.allowEmptyTime ?
                this.isOneOfDatesIsEmpty() || isTimepickerInputValid
                : isTimepickerInputValid;
            if (!isValid) {
        ...
        TimepickerComponent.prototype.updateSeconds = function (target) {
            ...
            var isTimepickerInputValid = isSecondInputValid(this.seconds) && this.isValidLimit();
            var isValid = this.config.allowEmptyTime ?
                this.isOneOfDatesIsEmpty() || isTimepickerInputValid
                : isTimepickerInputValid;
            if (!isValid) {
        ...
        TimepickerComponent.prototype.isOneOfDatesIsEmpty = function () {
        ...
        TimepickerComponent.prototype._updateTime = function () {
            ...
            var isTimepickerInputValid = isInputValid(this.hours, _minutes, _seconds, this.isPM());
            var isValid = this.config.allowEmptyTime ?
                this.isOneOfDatesIsEmpty() || isTimepickerInputValid
                : isTimepickerInputValid;
            if (!isValid) {
