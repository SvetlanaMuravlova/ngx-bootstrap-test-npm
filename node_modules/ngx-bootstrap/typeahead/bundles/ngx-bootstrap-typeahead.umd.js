(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('ngx-bootstrap/utils'), require('rxjs'), require('@angular/animations'), require('ngx-bootstrap/positioning'), require('@angular/common'), require('rxjs/operators'), require('ngx-bootstrap/component-loader'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('ngx-bootstrap/typeahead', ['exports', '@angular/core', 'ngx-bootstrap/utils', 'rxjs', '@angular/animations', 'ngx-bootstrap/positioning', '@angular/common', 'rxjs/operators', 'ngx-bootstrap/component-loader', '@angular/forms'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['ngx-bootstrap'] = global['ngx-bootstrap'] || {}, global['ngx-bootstrap'].typeahead = {}), global.ng.core, global.utils, global.rxjs, global.ng.animations, global.i1, global.ng.common, global.rxjs.operators, global.i1$1, global.ng.forms));
}(this, (function (exports, i0, utils, rxjs, animations, i1, i2, operators, i1$1, i3) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TypeaheadContainerComponent = /** @class */ (function () {
        ...
        Object.defineProperty(TypeaheadContainerComponent.prototype, "canSelectItemsOnBlur", {
            get: function () {
                var _a;
